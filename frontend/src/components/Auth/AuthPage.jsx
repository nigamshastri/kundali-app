...
const styles = {
  overlay: {
    ...
    background: "linear-gradient(135deg, #1a0a00, #2d1505, #1a0a00)"
  },
  card: {
    width: "100%", maxWidth: "420px",
    background: "linear-gradient(135deg, rgba(45,21,5,0.95), rgba(26,10,0,0.98))",
    border: "1px solid rgba(212,160,23,0.35)",
    borderRadius: "20px", padding: "2rem",
    boxShadow: "0 20px 60px rgba(0,0,0,0.5), inset 0 1px 0 rgba(212,160,23,0.2)"
  },
  ...
  tab: {
    flex: 1, padding: "0.6rem", background: "rgba(45,21,5,0.6)",
    border: "1px solid rgba(212,160,23,0.2)", borderRadius: "8px",
    color: "rgba(255,248,240,0.55)", cursor: "pointer", fontSize: "0.9rem",
    fontFamily: "'Noto Sans Gujarati', sans-serif", transition: "all 0.2s"
  },
  tabActive: {
  ...
  input: {
    ...
    padding: "0.65rem 0.9rem", color: "#fff8f0",
    fontFamily: "'Noto Sans Gujarati', sans-serif", fontSize: "0.95rem",
    outline: "none", boxSizing: "border-box"
  },
  error: {
    background: "rgba(180,50,50,0.15)", border: "1px solid rgba(180,50,50,0.4)",
    borderRadius: "8px", padding: "0.6rem 0.9rem",
    color: "#e88a7c", fontSize: "0.85rem", marginBottom: "1rem"
  },
  btn: {
    width: "100%", padding: "0.85rem",
    background: "linear-gradient(135deg, #8b1a1a, #ff6b1a, #d4a017)",
    border: "none", borderRadius: "10px", color: "white",
    fontFamily: "'Yatra One', cursive", fontSize: "1.1rem",
    cursor: "pointer", marginTop: "0.5rem",
    boxShadow: "0 4px 20px rgba(255,107,26,0.3)"
  }
};
