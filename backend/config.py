...
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://nigamshastri4_db_user:R5gqwa97@cluster0.2njphyw.mongodb.net/kundali_db?retryWrites=true&w=majority&tlsAllowInvalidCertificates=true")
